...
ROOT_URLCONF = 'cloudflare_project.urls'
...
WSGI_APPLICATION = 'cloudflare_project.wsgi.application'

# Database (default SQLite, can be changed to PostgreSQL, MySQL, etc.)
DATABASES = {
    'default': {
...
if os.path.isfile(FIREBASE_CREDENTIALS):
    ...
    raise FileNotFoundError(f"Firebase service account key not found at {FIREBASE_CREDENTIALS}")
